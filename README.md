...
:warning: 현재 uvloop 라이브러리로 인해 Mac과 리눅스 환경에서만 동작 가능합니다...(Windows는 WSL로 진행하셔야 합니다!) <br>
:link: [MAC 세팅 참고 노션페이지][NotionLink-MAC] <br>
:link: [WSL 세팅 참고 노션페이지][NotionLink-WSL]
